...
(function(){
    ...
    if(!RADIO_ALLOWED){
      ...
      document.addEventListener('DOMContentLoaded',function(){ try{
        if(!document.getElementById('kil-radio') && !document.querySelector('script[src*="keepitil-radio"]')){
          ...
          var _rs=document.createElement('script'); _rs.defer=true; _rs.src='/assets/js/keepitil-radio.js?v=20260909c'; document.body.appendChild(_rs);
        }
      }catch(e){} });
    }
  }catch(e){}
  ...
  try{
    ...
    if('serviceWorker' in navigator){
      ...
      navigator.serviceWorker.register('/sw.js?v=20260909g').catch(function(){});
