...
(function(){if(!window.__kilRadioInit){var s=document.createElement('script');s.src='/assets/js/keepitil-radio.js?v=20260909a';document.head.appendChild(s);}})();
  ...
  var KB = [
    ...
    },
    {
      ...
      links: [
        ...
        { url: 'https://keepitil.com/signup', label: 'Get Listed on KEEPITIL' },
      ],
    ...
    },
    {
      ...
      links: [
        { url: 'https://keepitil.com/signup', label: 'List Your Event on KEEPITIL' },
      ],
    ...
    },
    {
      ...
      links: [
        { url: 'https://keepitil.com/signup', label: 'Subscribe to KEEPITIL' },
      ],
      chips: ['Find upcoming events', 'About KEEPITIL', 'Culture blog'],
    },
    {
      ...
      links: [
        ...
        { url: 'https://keepitil.com/culture', label: 'Culture Blog' },
        { url: 'https://keepitil.com/signup', label: 'Subscribe' },
      ],
    ...
    },
    {
      ...
      links: [
        { url: 'https://keepitil.com/signup', label: 'Contact & Subscribe' },
      ...
      try {
        ...
        try {
          ...
          f.innerHTML = '<span style="color:#9aa;font-size:.8rem">The assistant is unavailable. ' +
                        ...
                        '<a class="kilo-action" href="/apply">Log in</a></span>';
          msgs.appendChild(f);
        } catch (e2) {}
      }
    }
